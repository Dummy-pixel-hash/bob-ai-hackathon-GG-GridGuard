...
class StepDef:
    ...
    In production the demo uses ~10–14-second steps so a full run takes
    ~1.5 minutes.  Tests inject a tiny duration (0.01 s).
    label_override:
...
_SCENARIO_STORM_SURGE = [
    ...
    StepDef(SimulationPhase.PEAK_STORM,          duration_s=13,
    ...
    StepDef(SimulationPhase.DEGRADATION_PEAK,    duration_s=12,
    ...
    StepDef(SimulationPhase.MAINTENANCE_TRIGGERED, duration_s=13,
...
_SCENARIO_HEAT_LOAD = [
    ...
    StepDef(SimulationPhase.RECOVERY,            duration_s=13,
...
_SCENARIO_REPEAT_FAULT = [
    ...
    StepDef(SimulationPhase.ADVISORY,            duration_s=12,
    ...
    StepDef(SimulationPhase.STORM_APPROACHING,   duration_s=13,
    ...
    StepDef(SimulationPhase.PEAK_STORM,          duration_s=12,
...
_SCENARIO_EQUIPMENT_FAULT = [
    ...
    StepDef(SimulationPhase.DEGRADATION_PEAK,    duration_s=10,
...
_SCENARIO_RECOVERY = [
    StepDef(SimulationPhase.PEAK_STORM,          duration_s=10,
            sensor_pressure=0.55,
    ...
    StepDef(SimulationPhase.MAINTENANCE_TRIGGERED, duration_s=14,
